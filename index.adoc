...
=== Sound
==== General sound rules
All sounds should be mastered such that its volume is relative to other existing sounds of the same type.
...
Title screen track have fewer rules.
These will usaully be arrangements of the Doctor Who theme, but other special themes (perhaps the themes from various Doctor Who spin-offs) may be included as well.
These will usually be *upbeat* (especially compared to the ambient tracks) and are free in their intrumentaiton. +
